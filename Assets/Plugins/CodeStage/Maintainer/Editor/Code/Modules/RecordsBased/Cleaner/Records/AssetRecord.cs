...
namespace CodeStage.Maintainer.Cleaner
{
	...
	public class AssetRecord : CleanerRecord, IShowableRecord
	{
		...
		public void Show()
		{
			...
			{
				string guid = AssetDatabase.AssetPathToGUID(assetDatabasePath);
				...
				if (mi == null)
				{
					Debug.LogWarning(Maintainer.LOG_PREFIX + "Can't find GetInstanceIDFromGUID via reflection. Possible API change.\nPlease report to " + Maintainer.SUPPORT_EMAIL);
					return;
				}
