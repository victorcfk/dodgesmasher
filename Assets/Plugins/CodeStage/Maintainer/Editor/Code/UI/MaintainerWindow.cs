...
namespace CodeStage.Maintainer.UI
{
	public class MaintainerWindow : EditorWindow
	{
		...
		{
			Create().currentTab = 3;
			MaintainerSettings.Instance.selectedTabIndex = 3;
		}*/
		...
		private void CreateTabs()
		{
			...
			{
				tabsCaptions = new[] {issuesTab.Caption, cleanerTab.Caption/*, usagesTab.Caption*/, aboutTab.Caption};
			}
		}
