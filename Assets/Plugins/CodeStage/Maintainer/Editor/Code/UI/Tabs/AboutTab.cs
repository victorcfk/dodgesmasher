...
namespace CodeStage.Maintainer.UI
{
	...
	{
		private const string UAS_LINK_SHORT = "content/32199?aid=1011lGBp&pubref=Maintainer";
		private const string UAS_LINK = "https://www.assetstore.unity3d.com/#!/content/32199?aid=1011lGBp&pubref=Maintainer";
			...
			using (layout.Horizontal())
			{
				...
				using (layout.Vertical(UIHelpers.panelWithBackground, GUILayout.ExpandHeight(true), GUILayout.ExpandWidth(true)))
				{
					...
					if (UIHelpers.ImageButton("Plugin at Unity Asset Store", "Hold CTRL / CMD to open in built-in Asset Store browser.", CSIcons.AssetStore))
					{
						...
						{
							UnityEditorInternal.AssetStore.Open(UAS_LINK_SHORT);
						}
					}
